											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td style="text-align: center;">
														...
														<button data-toggle="modal" data-target="#editModal<?php echo $p['idproduk'] ?>" class="btn btn-success">Edit</button>
														
														<div id="editModal<?php echo $p['idproduk'] ?>" class="modal fade" style="text-align: left;">
					...
					<div class="modal-content">
						...
						<input type="hidden" name="idproduk" value="<?= $p['idproduk']?>">
							...
							<div class="modal-footer">
								...
								<input type="submit" name="deleteproduk" class="btn btn-danger" value="Hapus">
							</div>
						</form>
					</div>
				</div>
